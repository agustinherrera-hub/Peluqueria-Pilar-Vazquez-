...
function getTiempsTinte(servicios) {
    ...
    // Ordenar de más específico (más largo) a más genérico para evitar que
    // "TINTE CORTE" machee antes que "TINTE CORTE Y PEINADO"
    const entradasOrdenadas = Object.entries(TIEMPOS_TINTE).sort((a, b) => b[0].length - a[0].length);
