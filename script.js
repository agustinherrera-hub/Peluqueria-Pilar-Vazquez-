...
async function cargarDatosDesdeSheet(silencioso = false) {
    try {
        ...
        // Solo limpiar servicios si NO hay categoría activa: evita pantalla en blanco
        // cuando llega un refresco automático mientras el usuario está eligiendo servicios
        const _catActual = document.getElementById('selectCategoria');
        const contS = document.getElementById('contenedorServicios');
        if (contS && _catActual && !_catActual.value) contS.innerHTML = '';
