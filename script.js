...
function confirmarServicios() {
    ...
    // Regenerar botones de hora para que los tramos del bloque recién confirmado
    // queden marcados como ocupados al seleccionar la siguiente trabajadora.
    // generarBotonesHora() lee bloquesConfirmados, así que con trabajadora vacía
    // simplemente limpia el grid; en cuanto se elija una nueva trabajadora
    // se volverá a llamar y ya excluirá las horas reservadas.
    generarBotonesHora();
