...
// Reemplaza el <datalist> nativo para funcionar
// igual en móvil y escritorio (siempre al lado,
// nunca debajo del teclado virtual)
// ─────────────────────────────────────────────
...
function filtrarAutocompletado(valor) {
    ...
    dropdown.querySelectorAll('.autocomplete-item').forEach(item => {
        item.addEventListener('mousedown', (e) => {
            e.preventDefault(); // evita que el input pierda el foco antes de leer el valor
...
function seleccionarAutocompletado(nombre) {
    ...
    if (input) {
        input.value = nombre;
        // Disparar los eventos que ya escuchaba el formulario
...
function actualizarActivoDropdown(items) {
    items.forEach((item, i) => {
        ...
        if (i === _autocompleteIndiceActivo) {
